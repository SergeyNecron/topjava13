...
public class MealsUtil {
    ...
    public static List<Meal> createList (){
        id=0;
        List<Meal> rezult = new ArrayList<>();
        rezult.add(new Meal(LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500));
        rezult.add(new Meal(LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 1000));
        rezult.add(new Meal(LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 600));
        rezult.add(new Meal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000));
        rezult.add(new Meal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500));
        rezult.add(new Meal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 500));
    //Не мог добавить новый элемент в Arrays.asList() Переделал на ArrayList
        return rezult;
    }
    public static void main(String[] args) {
        List<Meal> meals = createList();
        List<MealWithExceed> mealsWithExceeded = getFilteredWithExceeded(meals, LocalTime.of(0, 0), LocalTime.of(12, 0), 2000);
